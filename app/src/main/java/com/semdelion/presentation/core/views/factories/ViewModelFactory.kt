...
inline fun <reified VM : ViewModel> ComponentActivity.viewModel() =  viewModels<VM> {

    val application = this.application

    val baseActivityViewModel = (this as ActivityDelegateHolder).delegate.getBaseActivityViewModel()
    ...
    ViewModelFactory(dependencies, this, null)
}
